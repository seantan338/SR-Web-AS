...
import { 
  Search, Filter, CheckCircle, XCircle, Clock, User, FileText, 
  ExternalLink, Mail, Lock, Database, Server, Info, ChevronRight,
  ChevronDown, Terminal, Sparkles, Plus, Loader2, Briefcase, Building2, DollarSign
} from 'lucide-react';
import { cn } from '@/src/lib/utils';
import { db, collection, onSnapshot, query, where, orderBy, addDoc, updateDoc, doc, OperationType, handleFirestoreError } from '@/src/firebase';
...
export default function RecruiterDashboard() {
  ...
  // Form state for candidate submission
  ...
  const handleSubmitCandidate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Candidate submitted successfully and synced to Google Sheets!');
              ...
              {activeTab === 'submit-candidate' && (
                ...
                >
                  <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-bold text-slate-900">Submit Potential Candidate</h2>
                  </div>
                  ...
                  <form onSubmit={handleSubmitCandidate} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          required
                          type="text" 
                          value={candidateSubmission.candidateName}
                      ...
                      <div className="space-y-2">
                        ...
                        <input 
                          required
                          type="email" 
                          value={candidateSubmission.candidateEmail}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input 
                          required
                          type="text" 
                          value={candidateSubmission.candidatePhone}
                      ...
                      <div className="space-y-2">
                        ...
                        <select 
                          value={candidateSubmission.targetJobId}
                    ...
                    <div className="space-y-2">
                      ...
                      <input 
                        type="text" 
                        value={candidateSubmission.resumeUrl}
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        rows={4}
                        value={candidateSubmission.notes}
                        ...
                        placeholder="Initial screening notes, salary expectations, notice period..."
                      />
                    </div>
                  ...
                  <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
                    <div className="flex items-center justify-between mb-6">
                      <h2 className="text-xl font-bold text-slate-900 flex items-center">
                        ...
                        Internal Job Orders (Secret Board)
                      </h2>
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                              ...
                              <div className="flex items-center space-x-6">
                                ...
                                <div className="flex items-center space-x-2">
                                  <button 
                                    onClick={() => {
                                      setCandidateSubmission(prev => ({ ...prev, targetJobId: job.id }));
                                      setActiveTab('submit-candidate');
                                    }}
                                  ...
                                  <button className="p-2 bg-slate-100 text-slate-400 rounded-lg hover:bg-orange-500 hover:text-white transition-all">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 p-6 rounded-2xl text-white">
              ...
              <p className="text-sm text-slate-400 mb-4">
                All candidate submissions and job applications are automatically synced to your master Google Sheet for data collection.
              </p>
